...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{}` \n\nɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ @joostringbot".format("ᴛᴇʟᴇᴛʜᴏɴ" if telethon else "ᴘʏʀᴏɢʀᴀᴍ", string_session)
    await client.send_message("me", text)
    await client.disconnect()
    await phone_code_msg.reply("ʙᴇʀʜᴀsɪʟ ᴍᴇɴɢᴀᴍʙɪʟ {} sᴛʀɪɴɢ sᴇssɪᴏɴ. \n\sɪʟᴀʜᴋᴀɴ ᴄᴇᴋ ᴘᴇsᴀɴ ᴛᴇʀsɪᴍᴘᴀɴ. \n\nʙʏ @ikhsanntarjo".format("ᴛᴇʟᴇᴛʜᴏɴ" if telethon else "ᴘʏʀᴏɢʀᴀᴍ"))
